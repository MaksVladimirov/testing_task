...
| 4  | Блокировка аккаунта при множественных неверных попытках входа | 1. Ввести неправильный пароль 5 раз.                                            | Аккаунт временно заблокирован, требуется капча или сброс пароля. | Не выполнено|
